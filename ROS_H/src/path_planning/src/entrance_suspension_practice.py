...
rospy.Subscriber("/regionFlag", Int64, update)
rospy.Subscriber("/holderFlag", Int64, update)
rospy.Subscriber("/line/centroid", Int64, update_x_centroid)
rospy.Subscriber("/line/orientation", Float64, update_orientation)

'''
rospy.Subscriber("/mapdata/stage_position", Float64MultiArray, update_entrance_direction_info)
'''
#node initiation
