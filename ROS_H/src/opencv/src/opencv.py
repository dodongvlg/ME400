...
b = [95, 129, 159, 255, 0, 255]     # high hue, low hue, high calue, low value, high sat, low sat
bC = [1, 901, 1, 26, 0, 244, 7]     # parameter related to circles (dp,minDist,param1,param2,minRadius,maxRadius,BlurSize)
